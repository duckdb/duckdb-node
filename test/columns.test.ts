...
describe('Column Types', function() {
    ...
    it('should prepare a statement and return the columns and their types', function(done) {
      ...
      var stmt = db.prepare("SELECT * EXCLUDE(medium_enum, large_enum, fixed_int_array, fixed_varchar_array, fixed_nested_int_array, fixed_nested_varchar_array, fixed_struct_array, struct_of_fixed_array, fixed_array_of_int_list, list_of_fixed_int_array, bignum) FROM test_all_types()", function(err: null | Error) {
