...
exports.Set(Napi::String::New(env, "duckdb_query_progress"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<double, duckdb_connection, duckdb_query_progress>>(env));
...
exports.Set(Napi::String::New(env, "duckdb_vector_ensure_validity_writable"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1Void<duckdb_vector, duckdb_vector_ensure_validity_writable>>(env));
...
exports.Set(Napi::String::New(env, "duckdb_init_get_extra_info"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<void*, duckdb_init_info, duckdb_init_get_extra_info>>(env));
exports.Set(Napi::String::New(env, "duckdb_init_get_bind_data"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<void*, duckdb_init_info, duckdb_init_get_bind_data>>(env));
exports.Set(Napi::String::New(env, "duckdb_init_set_init_data"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper3Void<duckdb_init_info, void*, duckdb_delete_callback_t, duckdb_init_set_init_data>>(env));
exports.Set(Napi::String::New(env, "duckdb_init_get_column_count"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<idx_t, duckdb_init_info, duckdb_init_get_column_count>>(env));
exports.Set(Napi::String::New(env, "duckdb_init_get_column_index"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2<idx_t, duckdb_init_info, idx_t, duckdb_init_get_column_index>>(env));
exports.Set(Napi::String::New(env, "duckdb_init_set_max_threads"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2Void<duckdb_init_info, idx_t, duckdb_init_set_max_threads>>(env));
exports.Set(Napi::String::New(env, "duckdb_init_set_error"), Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2Void<duckdb_init_info, const char*, duckdb_init_set_error>>(env));
