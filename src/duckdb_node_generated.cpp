...
static void RegisterGenerated(Napi::Env env, Napi::Object exports) {
	exports.Set(Napi::String::New(env, "type"),
	            duckdb_node::PointerHolder<duckdb_type>::Init(env, "duckdb_type")->Value());
	exports.Set(Napi::String::New(env, "date"),
	            duckdb_node::PointerHolder<duckdb_date>::Init(env, "duckdb_date")->Value());
	exports.Set(Napi::String::New(env, "date_struct"),
	...
	exports.Set(Napi::String::New(env, "open_ext"),
	...
	exports.Set(
	    Napi::String::New(env, "set_config"),
	...
	exports.Set(
	    Napi::String::New(env, "to_timestamp"),
	...
	exports.Set(
	    Napi::String::New(env, "param_type"),
	...
	exports.Set(
	    Napi::String::New(env, "clear_bindings"),
	...
	exports.Set(
	    Napi::String::New(env, "extract_statements_error"),
	...
	exports.Set(
	    Napi::String::New(env, "destroy_extracted"),
	...
	exports.Set(Napi::String::New(env, "pending_prepared"),
	...
	exports.Set(Napi::String::New(env, "execute_pending"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::AsyncFunctionWrapper2<
	                duckdb_state, duckdb_pending_result, duckdb_result *, duckdb_execute_pending>>(env));
	exports.Set(Napi::String::New(env, "pending_execution_is_finished"),
	...
	exports.Set(
	    Napi::String::New(env, "create_list_type"),
	...
	exports.Set(
	    Napi::String::New(env, "enum_dictionary_value"),
	...
	exports.Set(
	    Napi::String::New(env, "list_type_child_type"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<duckdb_logical_type, duckdb_logical_type,
	                                                                        duckdb_list_type_child_type>>(env));
	exports.Set(
	    Napi::String::New(env, "map_type_key_type"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<duckdb_logical_type, duckdb_logical_type,
	                                                                        duckdb_map_type_key_type>>(env));
	exports.Set(
	    Napi::String::New(env, "map_type_value_type"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<duckdb_logical_type, duckdb_logical_type,
	                                                                        duckdb_map_type_value_type>>(env));
	exports.Set(
	    Napi::String::New(env, "struct_type_child_count"),
	...
	exports.Set(
	    Napi::String::New(env, "data_chunk_get_vector"),
	...
	exports.Set(Napi::String::New(env, "data_chunk_get_size"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<idx_t, duckdb_data_chunk,
	                                                                                duckdb_data_chunk_get_size>>(env));
	exports.Set(
	    Napi::String::New(env, "data_chunk_set_size"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper2Void<duckdb_data_chunk, idx_t, duckdb_data_chunk_set_size>>(
	        env));
	exports.Set(
	    Napi::String::New(env, "vector_get_column_type"),
	...
	exports.Set(Napi::String::New(env, "vector_assign_string_element_len"),
	...
	exports.Set(
	    Napi::String::New(env, "list_vector_get_child"),
	...
	exports.Set(Napi::String::New(env, "list_vector_reserve"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2<duckdb_state, duckdb_vector, idx_t,
	                                                                                duckdb_list_vector_reserve>>(env));
	exports.Set(
	    Napi::String::New(env, "struct_vector_get_child"),
	...
	exports.Set(Napi::String::New(env, "table_function"),
	            duckdb_node::PointerHolder<duckdb_table_function>::Init(env, "duckdb_table_function")->Value());
	exports.Set(Napi::String::New(env, "bind_info"),
	            duckdb_node::PointerHolder<duckdb_bind_info>::Init(env, "duckdb_bind_info")->Value());
	exports.Set(Napi::String::New(env, "init_info"),
	            duckdb_node::PointerHolder<duckdb_init_info>::Init(env, "duckdb_init_info")->Value());
	exports.Set(Napi::String::New(env, "function_info"),
	            duckdb_node::PointerHolder<duckdb_function_info>::Init(env, "duckdb_function_info")->Value());
	exports.Set(Napi::String::New(env, "bind_get_extra_info"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<void *, duckdb_bind_info,
	                                                                                duckdb_bind_get_extra_info>>(env));
	exports.Set(Napi::String::New(env, "bind_add_result_column"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper3Void<
	                duckdb_bind_info, const char *, duckdb_logical_type, duckdb_bind_add_result_column>>(env));
	exports.Set(
	    Napi::String::New(env, "bind_get_parameter_count"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper1<idx_t, duckdb_bind_info, duckdb_bind_get_parameter_count>>(
	        env));
	exports.Set(
	    Napi::String::New(env, "bind_get_parameter"),
	...
	exports.Set(Napi::String::New(env, "bind_set_error"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2Void<duckdb_bind_info, const char *,
	                                                                                    duckdb_bind_set_error>>(env));
	exports.Set(Napi::String::New(env, "init_get_extra_info"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<void *, duckdb_init_info,
	                                                                                duckdb_init_get_extra_info>>(env));
	exports.Set(
	    Napi::String::New(env, "init_get_bind_data"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper1<void *, duckdb_init_info, duckdb_init_get_bind_data>>(env));
	exports.Set(Napi::String::New(env, "init_set_init_data"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper3Void<
	                duckdb_init_info, void *, duckdb_delete_callback_t, duckdb_init_set_init_data>>(env));
	exports.Set(
	    Napi::String::New(env, "init_get_column_count"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper1<idx_t, duckdb_init_info, duckdb_init_get_column_count>>(
	        env));
	exports.Set(
	    Napi::String::New(env, "init_get_column_index"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2<idx_t, duckdb_init_info, idx_t,
	                                                                        duckdb_init_get_column_index>>(env));
	exports.Set(
	    Napi::String::New(env, "init_set_max_threads"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper2Void<duckdb_init_info, idx_t, duckdb_init_set_max_threads>>(
	        env));
	exports.Set(Napi::String::New(env, "init_set_error"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2Void<duckdb_init_info, const char *,
	                                                                                    duckdb_init_set_error>>(env));
	exports.Set(
	    Napi::String::New(env, "function_get_extra_info"),
	...
	exports.Set(
	    Napi::String::New(env, "function_get_bind_data"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<void *, duckdb_function_info,
	                                                                        duckdb_function_get_bind_data>>(env));
	exports.Set(
	    Napi::String::New(env, "function_get_init_data"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<void *, duckdb_function_info,
	                                                                        duckdb_function_get_init_data>>(env));
	exports.Set(
	    Napi::String::New(env, "function_get_local_init_data"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<void *, duckdb_function_info,
	                                                                        duckdb_function_get_local_init_data>>(env));
	exports.Set(
	    Napi::String::New(env, "function_set_error"),
	...
	exports.Set(
	    Napi::String::New(env, "replacement_scan_info"),
	    duckdb_node::PointerHolder<duckdb_replacement_scan_info>::Init(env, "duckdb_replacement_scan_info")->Value());
	exports.Set(
	    Napi::String::New(env, "appender_create"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::AsyncFunctionWrapper4<
	        duckdb_state, duckdb_connection, const char *, const char *, duckdb_appender *, duckdb_appender_create>>(
	        env));
	exports.Set(Napi::String::New(env, "appender_error"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<const char *, duckdb_appender,
	                                                                                duckdb_appender_error>>(env));
	exports.Set(Napi::String::New(env, "appender_flush"),
	...
	exports.Set(Napi::String::New(env, "appender_close"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::AsyncFunctionWrapper1<duckdb_state, duckdb_appender,
	                                                                                     duckdb_appender_close>>(env));
	exports.Set(
	    Napi::String::New(env, "appender_destroy"),
	    Napi::Function::New<duckdb_node::FunctionWrappers::AsyncFunctionWrapper1<duckdb_state, duckdb_appender *,
	                                                                             duckdb_appender_destroy>>(env));
	exports.Set(Napi::String::New(env, "appender_begin_row"),
	...
	exports.Set(
	    Napi::String::New(env, "append_int16"),
	...
	exports.Set(
	    Napi::String::New(env, "append_int32"),
	...
	exports.Set(
	    Napi::String::New(env, "append_int64"),
	...
	exports.Set(Napi::String::New(env, "append_hugeint"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2<
	                duckdb_state, duckdb_appender, duckdb_hugeint, duckdb_append_hugeint>>(env));
	exports.Set(
	    Napi::String::New(env, "append_uint8"),
	...
	exports.Set(
	    Napi::String::New(env, "append_uint16"),
	...
	exports.Set(
	    Napi::String::New(env, "append_uint32"),
	...
	exports.Set(
	    Napi::String::New(env, "append_uint64"),
	...
	exports.Set(Napi::String::New(env, "append_float"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2<duckdb_state, duckdb_appender,
	                                                                                float, duckdb_append_float>>(env));
	exports.Set(
	    Napi::String::New(env, "append_double"),
	...
	exports.Set(
	    Napi::String::New(env, "append_date"),
	...
	exports.Set(
	    Napi::String::New(env, "append_time"),
	...
	exports.Set(
	    Napi::String::New(env, "append_varchar_length"),
	...
	exports.Set(
	    Napi::String::New(env, "append_blob"),
	...
	exports.Set(
	    Napi::String::New(env, "append_null"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper1<duckdb_state, duckdb_appender, duckdb_append_null>>(env));
	exports.Set(Napi::String::New(env, "append_data_chunk"),
	            Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper2<
	                duckdb_state, duckdb_appender, duckdb_data_chunk, duckdb_append_data_chunk>>(env));
	exports.Set(Napi::String::New(env, "task_state"),
	            duckdb_node::PointerHolder<duckdb_task_state>::Init(env, "duckdb_task_state")->Value());
	exports.Set(
	    Napi::String::New(env, "execute_tasks"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::AsyncFunctionWrapper2Void<duckdb_database, idx_t, duckdb_execute_tasks>>(
	        env));
	exports.Set(Napi::String::New(env, "create_task_state"),
