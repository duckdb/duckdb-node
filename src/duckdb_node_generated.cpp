...
static void RegisterGenerated(Napi::Env env, Napi::Object exports) {
	...
	exports.Set(
	    ...
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<bool, duckdb_date, duckdb_is_finite_date>>(
	        env));
	exports.Set(
	...
	exports.Set(
	    ...
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper1<bool, duckdb_timestamp, duckdb_is_finite_timestamp>>(env));
	exports.Set(
	...
	exports.Set(
	    ...
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper1<double, duckdb_uhugeint, duckdb_uhugeint_to_double>>(env));
	exports.Set(
	    Napi::String::New(env, "duckdb_double_to_uhugeint"),
	    Napi::Function::New<
	        duckdb_node::FunctionWrappers::FunctionWrapper1<duckdb_uhugeint, double, duckdb_double_to_uhugeint>>(env));
	exports.Set(
	...
	exports.Set(Napi::String::New(env, "duckdb_execute_prepared_streaming"),
	...
	exports.Set(
	    ...
	    Napi::Function::New<duckdb_node::FunctionWrappers::FunctionWrapper1<duckdb_pending_state, duckdb_pending_result,
	                                                                        duckdb_pending_execute_check_state>>(env));
